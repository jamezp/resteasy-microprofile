...
Full reference documentation is available in the link:docs/[docs] directory and will be published at
https://docs.resteasy.dev/resteasy-microprofile[docs.resteasy.dev/resteasy-microprofile].

To build the documentation locally:
----
./mvnw clean javadoc:aggregate -Pcentral-release
./mvnw process-resources -pl docs
----

The generated HTML and PDF will be in `docs/target/generated-docs/`. The Javadocs will be generated in the
`arget/reports/apidocs` directory.
